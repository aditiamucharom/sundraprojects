...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row w-full max-w-full h-screen overflow-hidden">
      {/* Mobile Top Navbar */}
      <header className="md:hidden flex items-center justify-between px-4 py-3 bg-card border-b border-border-custom">
      ...
      <aside className="hidden md:flex md:flex-col md:w-68 flex-shrink-0">
      ...
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col w-full max-w-full min-w-0 overflow-y-auto overflow-x-hidden bg-background transition-colors duration-200">
        {/* Top desktop header bar */}
        <header className="hidden md:flex items-center justify-between px-8 py-4 border-b border-border-custom/50 bg-card/10 backdrop-blur-md">
          <div>
        ...
        {/* Page Inner Content */}
        <div className="flex-1 flex flex-col w-full max-w-full overflow-x-hidden p-4 md:p-8">
          {children}
        </div>
      </main>
